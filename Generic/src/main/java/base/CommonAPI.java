...
public class CommonAPI {
    ...
    private String saucelabs_username = "cgpatel";
    private String browserstack_username = "chirayupatel";
    ...
    public void setUp(@Optional("false") boolean useCloudEnv,
                      ...
                      @Optional("http://www.php.net") String url)throws IOException {
        if(useCloudEnv==true){
    ...
    //get Links
    public String getLinks(String locator){
